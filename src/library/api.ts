...
/** 카테고리별 목록 조회. */
export async function listAssets(token: string, category: 'maps' | 'characters' | 'bgm' | '_schemas' | '_folders' | 'all'): Promise<BlobItem[]> {
...
export async function uploadAsset(
  token: string,
  category: 'maps' | 'characters' | 'bgm' | '_schemas' | '_folders',
  file: File,
